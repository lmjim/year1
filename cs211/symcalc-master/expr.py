...
class BinOp(Expr):
    ...
    def _apply(self, left, right):
        raise NotImplementedError("You need to override _apply")
...
class Times(BinOp):
    ...
    def __repr__(self):
        return "Times(Const({}), Const({}))".format(self.left, self.right)
...
class Plus(BinOp):
    ...
    def __repr__(self):
        return "Plus(Const({}),Const({}))".format(self.left, self.right)
...
class Minus(BinOp):
    ...
    def __repr__(self):
        return "Minus(Const({}),Const({}))".format(self.left, self.right)
...
class Div(BinOp):
    ...
    def __repr__(self):
        return "Div(Const({}), Const({}))".format(self.left, self.right)
