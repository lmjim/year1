...
class BinOp(Expr):
    ...
    def gen(self, context: Context, target: str):
        ...
        self.left.gen(context, target)
        temp_reg = context.alloc_reg()
        self.right.gen(context, temp_reg)
        op = self._opcode()
        context.add_line("{} {},{},{}".format(op, target, target, temp_reg))
    ...
    def _opcode(self):
        ...
        """
        raise NotImplementedError("Class {} doesn't have _opcode method".format(type(self)))
